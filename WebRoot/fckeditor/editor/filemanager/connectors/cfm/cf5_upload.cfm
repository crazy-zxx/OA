...
<cfscript>
	function SendUploadResults(errorNumber, fileUrl, fileName, customMsg)
	{
		...
		// Minified version of the document.entity automatic fix script (#1919).
		// The original script can be found at _dev/domain_fix_template.js
		WriteOutput("(function(){var d=document.entity;while (true){try{var A=window.parent.document.entity;break;}catch(e) {};d=d.replace(/.*?(?:\.|$)/,'');if (d.length==0) break;try{document.entity=d;}catch (e){break;}}})();");
